import { GAME_SIZE, SCORE } from "../core/constants.js";
//import { getHighScore } from "../core/highscore.js";
import { initScoreSystem, loadHighScore, getHiScore, resetHighScore } from "../core/scoreSystem.js";
...
export class MainMenu extends Phaser.Scene {
  ...
  async create() {
    ...
    const hiScore = getHiScore().toString().padStart(SCORE.NUMBER_OF_DIGITS, '0');
